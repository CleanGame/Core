namespace CleanGame.Domain.Base.Result;
...
public static class ResultExtensions
{
    ...
    public static Result<T> Ensure<T>(this Result<T> result, Func<T, bool> predicate, Error error)
    {
        ...
        return result.IsSuccess && predicate(result.Value)
            ? result
            : CleanGame.Domain.Base.Result.Result.Failure<T>(error);
    }
    ...
    public static Result<TOut> Map<TIn, TOut>(this Result<TIn> result, Func<TIn, TOut> func) =>
        result.IsSuccess ? func(result.Value) : CleanGame.Domain.Base.Result.Result.Failure<TOut>(result.Error);
    ...
    /// </returns>
    public static async Task<CleanGame.Domain.Base.Result.Result> Bind<TIn>(this Result<TIn> result,
        Func<TIn, Task<CleanGame.Domain.Base.Result.Result>> func) =>
        result.IsSuccess ? await func(result.Value) : CleanGame.Domain.Base.Result.Result.Failure(result.Error);
    ...
    /// </returns>
    public static async Task<T> Match<T>(this Task<CleanGame.Domain.Base.Result.Result> resultTask, Func<T> onSuccess,
        Func<Error, T> onFailure)
    {
        CleanGame.Domain.Base.Result.Result result = await resultTask;
